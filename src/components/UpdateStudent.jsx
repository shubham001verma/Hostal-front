...
const UpdateStudent = () => {
    ...
    const handleUpdate = (e) => {
        ...
        formdata.append("floornumber", value.floornumber);  // Add room number

        formdata.append('totalFee', value.totalFee);
        formdata.append('paidAmount', value.paidAmount);
        formdata.append('registrationDate', value.registrationDate);  // Add registration date

        axios.put(`https://hostel-repo.onrender.com/student/updatestudent/${id}`, formdata)

            .then(res => {

                if (res.data.error) {
                    alert(res.data.error); // Alert if room number is already assigned
                } else {
        ...
        <>
            ...
            <div className='student-form container '>
                <form onSubmit={handleUpdate}>
                    {currentStep == 1 && (
                        <div class="row g-3 mt-1 form-step" >
                            <h2>Update Student Details</h2>
                            <div class="col-12  col-md-3 col-lg-3">
                                <label class="form-label">Student Name</label>
                                <input type="text" placeholder="Student Name" value={value.name} onChange={e => setValue({ ...value, name: e.target.value })}
                            ...
                            <div class="col-12  col-md-3 col-lg-3">
                                ...
                                <input type="number" value={value.age} onChange={e => setValue({ ...value, age: e.target.value })} placeholder='Age'

                                />
                            </div>
                            <div class="col-12  col-md-3 col-lg-3">
                                <label class="form-label">Student Mobile No.</label>
                                <input type="text" id="inputAddress" value={value.studentmobileno} placeholder="Mobile No" onChange={e => setValue({ ...value, studentmobileno: e.target.value })}
                                />
                            </div>
                            <div class="col-12  col-md-3 col-lg-3">
                            ...
                            <div class="col-12  col-md-12">
                                <label for="inputZip" class="form-label">Parmanent Address</label>
                                <input type="text" placeholder='Parmanent Address' value={value.parmanentaddress} onChange={e => setValue({ ...value, parmanentaddress: e.target.value })}
                    ...
                    {currentStep == 2 && (<div class="row g-3 mt-1 form-step ">
                        <h2>Parents Details</h2>
                        <div class="col-12  col-md-3 col-lg-3">
                            <label class="form-label">Fathers Name</label>
                            <input type="text" placeholder="Fathers Name" value={value.fathername} onChange={e => setValue({ ...value, fathername: e.target.value })}
                            />
                        </div>
                        <div class="col-12  col-md-3 col-lg-3">
                            <label class="form-label">Mothers Name</label>
                            <input type="text" placeholder='Maothers Name' value={value.mothername} onChange={e => setValue({ ...value, mothername: e.target.value })}
                            />
                        </div>
                        <div class="col-12  col-md-6 col-lg-6">
                            <label class="form-label">Parents Mobile No.</label>
                            <input type="text" id="inputAddress" placeholder="Mobile No." value={value.parentsmobileno} onChange={e => setValue({ ...value, parentsmobileno: e.target.value })}
                            />
                        </div>
                    ...
                    {
                        currentStep == 3 && (<div class="row g-3 mt-2 form-step" >
                            <h2>Documentation</h2>
                            <div class="col-12  col-md-3 col-lg-3">
                    ...
                    {currentStep == 4 && (
                        <div className="row g-3 mt-2 form-step" >
                            ...
                            <div className="col-12  col-md-6 col-lg-6">
                                ...
                                <input type="text" placeholder="Enter Room Number" value={value.roomnumber} onChange={e => setValue({ ...value, roomnumber: e.target.value })} />
                            </div>
                            ...
                            <div className="col-12 col-md-4 col-lg-4">
                                ...
                                <input type="text" placeholder="Bed Number" value={value.bednumber} onChange={e => setValue({ ...value, bednumber: e.target.value })} />
                    ...
                    <div className="form-navigation text-center">
                        ...
                        {currentStep === 5 && <button type="submit" className='btn2'>Update</button>}
                    </div>
